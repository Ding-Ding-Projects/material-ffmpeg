...
- Pages deployment now checks the fetched `origin/main` SHA immediately before configuration, upload, and deployment so a late stale workflow cannot overwrite a newer website.
