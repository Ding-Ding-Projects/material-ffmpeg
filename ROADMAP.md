...
## 0.1 — fully wired first release

- [x] Preserve the supplied design and application skeleton.
- [x] Pin official FFmpeg source as a repository submodule.
- [x] Add checksum-verified bundled FFmpeg and FFprobe delivery.
- [x] Add one-click build and unsigned Squirrel.Windows packaging scripts.
- [x] Add a responsive project site and automated Pages deployment.
- [x] Integrate trusted runtime/job management and complete the FFmpeg workflow renderer wiring.
- [x] Preserve the ZIP-supplied UI while wiring its tab, registry, job, generic context menus, search field, regex control, action hit testing, and viewport placement.
...
Work outside the FFmpeg desktop workflow is deliberately excluded.
